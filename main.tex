...
Parts for costumes Homewares
SketchUp SolidWorks AutoCAD
Length of print times
Print failures
Other/ Additional Information Resolution


Producing pretty much any piece of homeware/project material.
I would be a lot more experimental in my designs. Usually my designs are very much fixed by the time it comes to the print stage, so any afterthoughts or adjustments get left and/or forgotten about.
AcS
Chemical reactors, teaching aids, toys
1 Year
Daily
SketchUp 3DS max Blender AutoCAD Other/stinkercad
...
Using monthly for two years. Prototyping new interface devices and toys
Rhino SolidWorks 3DS max Other sMeshLab
Print failures


a. Cope with print failures
More of the same, plus interactive, actuated devices.


AcSCom
lead designer and founderesearch, workshops on 3D printing, promotion of market growth and community involvement opportunities. 
Ultimaker ABS PLA
I run 4 machines 6 days a week 24 hours. I usually experience 2/3 errors during prints per week
...
When using an ultimaker. With the other machines ramping up print density or slowing the print speed tends to rectify the problem
Machines with expandable and upgradable components and bed sizes, more refined and pro engineered components, something like the harley davidson product model: you buy a base unit and customise and upgrade it as you want to suit your needs.
...
3D printing and Additive Manufacturing Service industrial grade standards 
SLS SLA 
Materials: nylon, wax plaster 
in power causes print to drag, temperatures in the bill chambers to liquid or not liquid and 
wax light sereo-lithography mCHINE unreliable size and scaling upper rand build dimensions 
...
dust 
the machine organise so that it can send a text message when it fails 
the year feedback and notification 



Com
over two years large spectrum of non profit uses 
Ultimaker and maker bot, cura, PLA and ABS
Blockages in nozzle --- heat transfers up the material and softens, making it difficult to feed. This is being addressed in newer models of printer 
b. Bed not sticking
Makerbots with filament material are the most prone to failure at the lower end of the market
errors occur 99\% of the time and almost always at the beginning. 
Complete reliability 
No blockages 
Improve the filament based printing process to be as good as the resin machines 
Get multicolours working effectively, the Makerbot is on of the few who has had limited success 
...
Commercial 
technician printers producing models for architects, private clients one off prints
...
7) other human errors --- models destroyed on delivery or badly handled.
The improvement in the world of 3D printing I would like to see would ideally be:

1) free fixing software
2) machines, consumables, packaging, energy consumption 100\% environmentally friendly
3) consumables to be available in bulk to refill.
...
Director Commercial company providing wide range printer capabilities to private customers 
objet 260
inkject 
resin 
rubber --- over 60 materials 


Unreliable printer technology
We have maintenance contracts on our printers and carry out constant routine maintenance ourselves
Stratasys/Objet printers – very rare, 3D Systems/ZCorp printers 1 in 10 work completely There is no way to predict when the print fails 
Stratasys to take over 3D Systems and replace all their staff, 3D Printer manufacturers to stop competing with their customers and undercutting them with unfair trading practices, Universities to stop using subsidised equipment to undercut commercial businesses, the media to stop miss-informing the world about 3D Printing – I could go on 
Com
 couldn’t begin to list all the myriad problems you get with 3D Systems printers –
FDM --- Stratasys professional FDM printers 
temperature and nozzle extrusion. low level maintenance and preventable through regular planned calibration.  they just keep breaking down, its one thing after another. As Norman Foster (one of the biggest users of 3D Systems printers) said at the ZCorp (now owned by 3D Systems) World convention about 10 years ago – your 3D Printers are great but if only they were reliable!
pretty reliable but We have maintenance contracts on our printers and carry out constant routine maintenance ourselves

 Stratasys/Objet printers – very rare, 3D Systems/ZCorp printers 1 in 10 at best There is no predictability on this issue



Arc 
Using daily for over 2 years to build architectural Models
Rhino
Strength of material


a.Sceptical, I cannot see how the design outcome can be controlled. Maybe to fix flaws in geometry?
Printing building components --- larger scale
Arc 
using monthly for 1 year, to do joinery
Rhino AutoCAD
Length of print times
Print failures
Other/ Additional Information pollution
a. Components for architecture
Arc 
Using monthly  for over 2 years, printing artworks and for conservation purposes

Rhino
Cost Colour restrictions
a. Using it as a sketch tool to develop and demonstrate different ideas.
Arc 
Using weekly for over 2 years to  buildcomponent prototypes
Rhino SolidWorks
Length of print times
Strength of material
Cost
Other/ Additional InformationResolution & Minimum thickness
a. Not much else, I suppose it could automate mass-customization of products, so a person didn't need to make the customizations to the file manually
prototypes until high-resolution and better materials becomes more affordable, then, hopefully final building components
Bio 
Using less than 6 months, hardly ever
Microscope parts
SketchUp
...
Length of print times
Print failures
Other/ Additional Information Reproducibility
NA
Scu
making poly chromatic sculpures
Rhino MicroStation; Magics Meshlab  SLS, ZCorp SLA, Objet Polyjet.
Colour restrictions
Strength of material
Other/ Additional Information Infiltration issues on quality
Developing intricate abstract forms. 
versatile scale changes to object, on the fly modifications saving proofing time.
Des


Use it weekly, started a year ago. modelling 
Maya Rhino 3DS max, 
Cost 
Print failures 
Amazing
bring the big bang to designers and design
\fi
